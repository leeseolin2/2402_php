...
-- TABLE 생성
-- PRIMARY KEY AUTO_INCREMENT : 기본적으로 NOT NULL
-- 회원 정보 테이블
CREATE TABLE users (
   user_id INT PRIMARY KEY AUTO_INCREMENT
	...
	, created_at    DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP() COMMENT 'YYYY-MM-DD' 
	, deleted_at    DATETIME                COMMENT 'YYYY-MM-DD'  
);
...
CREATE TABLE products (
   product_id      INT          PRIMARY KEY AUTO_INCREMENT
	...
	, created_at    DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP() COMMENT 'YYYY-MM-DD'
	, updated_at    DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP() COMMENT 'YYYY-MM-DD'
