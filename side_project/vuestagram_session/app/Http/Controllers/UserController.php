...
class UserController extends Controller
{
    public function login(Request $request) {
        ...
        // 유저 정보 획득
        $userInfo = User::select('users.*')->selectSub(function($query) {
            $query->select(DB::raw('count(*)'))->from('boards')->whereColumn('users.id', 'boards.user_id');
        },'boards_count')
    ...
    public function logout() {
        ...
        Session::regenerateToken(); // CFRF 토큰 재발급
