...
// 변수1 >= 변수2, 변수1 <= 변수2 : 변수1이 변수2보다 크거나같다, 변수1이 변수2보다 작거나 같다
var_dump( 1 >= 1 ); 
var_dump( 1 >= 2 ); 
var_dump( 1 >= 0 ); 
...
// 변수1 == 변수2 : 변수1과 변수2가 같다, 불안전 비교(데이터 타입 체크 X)
var_dump( 1 == 1 );
var_dump( 1 == "1" );
...
var_dump( 1 != 1 );
var_dump( 1 != "1" );
// 변수 !== 변수2 : 변수1과 변수2가 같지 않다. 완전 비교(데이터 타입 체크 O)
var_dump( 1 !== 1 );
var_dump( 1 !== "1" );
...
var_dump( 1 === 1 && 2 === 2);
var_dump( 1 === 1 && 1 === 2);
// or 연산자(||) : 조건 중 하나라도 맞으면 true, 전부 틀리면 false
var_dump( 1 === 1 || 2 === 2);
var_dump( 1 === 1 || 1 === 2);
var_dump( 1 === 2 || 1 === 2);
// not 연산자(!) : 연산의 결과를 반전
